...
import "./Team.scss";
import alenka from "../../resources/images/team/alenka.png";
...
import fariha from "../../resources/images/team/fariha.png";
...
const photos = [
    ...
    { hot: joyce, goof: joyce2, name: "Joyce Jorda", role: "Finance Coordinator", linkedin: "" },
    ...
    { hot: angela, goof: angela2, name: "Angela Law", role: "Logistics Coordinator", LinkedIn: "" },
    ...
    { hot: alenka, goof: goose, name: "Alenka Rondon", role: "Marketing Coordinator", LinkedIn: "" },
    ...
    { hot: fariha, goof: goose, name: "Mahzabin Fariha", role: "Engineering Coordinator", LinkedIn: "" },
